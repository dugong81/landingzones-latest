...
module "prod_environment" {
  ...
  enable_shared_tools        = var.prod_enable_shared_tools
  ...
  igw_hub_check        = var.prod_igw_hub_check
  nat_gw_hub_check     = var.prod_nat_gw_hub_check
  service_gw_hub_check = var.prod_service_gw_hub_check
