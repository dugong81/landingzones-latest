...
| <a name="module_workload_expansion_spoke"></a> [workload\_expansion\_spoke](#module\_workload\_expansion\_spoke) | ../elz-jde-spoke | n/a |
...
| <a name="input_identity_domain_url"></a> [identity\_domain\_url](#input\_identity\_domain\_url) | identity domain url | `string` | `""` | no |
